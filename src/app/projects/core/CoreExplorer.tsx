    ...
    return <div className={styles.tabContent}>
        ...
        <section className={styles.section}>
            <h2>{t("core.forms")}</h2><div className={styles.formGrid}>
                <label>{t("core.textField")}<input placeholder={t("core.projectName")} /></label><label>E-Mail<input type="email" placeholder="name@oskar-lab.de" /></label>
...
export default function CoreExplorer({coreDocumentation, componentDocumentation}: Readonly<{coreDocumentation: readonly SourceDocumentation[]; componentDocumentation: readonly SourceDocumentation[]}>) {
    ...
    return <>
        <Header projectName="Core & Design" center={<Search value={query} onChange={setQuery} resultCount={searchResults.count} label={t("core.searchLabel")} placeholder={t("core.searchPlaceholder")} />} />
