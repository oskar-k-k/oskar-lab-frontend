...
export default function ProjectsExplorer({projects, backendAvailable}: Readonly<{projects: readonly Project[]; backendAvailable: boolean}>) {
    ...
    const localizedProjects = useMemo(() => projects.map(project => ({
        ...project,
        description: project.path === "portfolio" ? t("projects.portfolioDescription") : project.path === "core" ? t("projects.coreDescription") : project.path === "chess" ? t("projects.chessDescription") : project.path === "virtual-try-on" ? t("projects.virtualTryOnDescription") : project.description,
    })), [projects, t]);
