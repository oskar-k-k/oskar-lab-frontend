...
export default function PortfolioPage() {
    ...
    return <main className={styles.page}>
        <section className={styles.hero}>
            ...
            <div className={styles.portraitWrap}><div className={styles.orbit} aria-hidden="true" /><Image className={styles.portrait} src={appPath("/oskar.jpg")} alt="Oskar Konczarek" width={520} height={650} priority /></div>
        ...
        <section className={styles.work} id="work">
            ...
            <div className={styles.projectGrid}>
                <article className={styles.featuredProject}><span>Platform · 2026</span><h3>{t("portfolio.oskarLabTitle")}</h3><p>{t("portfolio.oskarLabText")}</p><a href={process.env.NEXT_PUBLIC_PLATFORM_URL || "/"}>{t("portfolio.viewProject")} ↗</a><div className={styles.projectGlow} /></article>
                <article><span>TypeScript · React</span><h3>{t("portfolio.chessTitle")}</h3><p>{t("portfolio.chessText")}</p><a href={`${process.env.NEXT_PUBLIC_PLATFORM_URL ?? ""}/apps/chess`}>{t("portfolio.viewProject")} ↗</a></article>
